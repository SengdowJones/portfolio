      ...
      <Container size="5xl">
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            {/* Available badge */}
            <div className="fade-in-up-blur-premium" style={{ '--fadein-delay': '700ms' } as React.CSSProperties}>
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl leading-8 text-gray-300 max-w-2xl mx-auto text-body fade-in-up-blur-premium" style={{ '--fadein-delay': '1500ms' } as React.CSSProperties}>
            ...
            {/* Badges row */}
            <div className="flex flex-wrap justify-center gap-4 fade-in-up-blur-premium" style={{ '--fadein-delay': '1900ms' } as React.CSSProperties}>
            ...
            {/* Location/email row */}
            <div className="flex items-center justify-center gap-8 text-sm text-gray-400 fade-in-up-blur-premium" style={{ '--fadein-delay': '2300ms' } as React.CSSProperties}>
            ...
            {/* Buttons */}
            <div className="flex items-center justify-center gap-4 mt-2 fade-in-up-blur-premium" style={{ '--fadein-delay': '2700ms' } as React.CSSProperties}>
              <Button 
                variant="primary" 
                size="md" 
