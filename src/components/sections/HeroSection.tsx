...
export default function HeroSection({ onEmailContact, onScrollToProjects }: HeroSectionProps) {
  return (
    <Section className="min-h-screen flex flex-col justify-start sm:justify-center items-center scroll-mt-20 relative overflow-hidden pt-[calc(env(safe-area-inset-top,0px)+4rem)]">
