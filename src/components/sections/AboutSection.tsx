          ...
          <div className="flex flex-col space-y-10 min-w-0 w-full max-w-full">
            ...
            <div className="scroll-reveal scroll-reveal-delay-1" ref={addScrollRef}>
              <div className="code-window-controls">
                ...
                <span className="code-window-title">achievements.jsx</span>
              </div>
              <div className="code-block overflow-x-auto max-w-full text-xs sm:text-sm">
                <pre className="font-mono text-left leading-relaxed whitespace-pre-wrap break-words">
                  <code>
                    ...
                    {"\n"}
                    {"\n"}
                    <span className="text-purple-400">const</span> <span className="text-blue-400">Achievements</span> = () =&gt; {'{'}
                    {"\n  return (\n    "}
                      <span className="text-blue-400">&lt;div</span> <span className="text-yellow-400">className</span>=<span className="text-green-400">&apos;achievements-grid&apos;</span><span className="text-blue-400">&gt;</span>{"\n      "}
                        <span className="text-blue-400">&lt;Award</span> <span className="text-yellow-400">title</span>=<span className="text-green-400">&apos;Best Technology&apos;</span> <span className="text-blue-400">/&gt;</span>{"\n      "}
                        <span className="text-blue-400">&lt;Hackathon</span> <span className="text-yellow-400">prize</span>=<span className="text-green-400">&apos;$2,000&apos;</span> <span className="text-blue-400">/&gt;</span>{"\n      "}
                        <span className="text-blue-400">&lt;Contest</span> <span className="text-yellow-400">result</span>=<span className="text-green-400">&apos;Winner&apos;</span> <span className="text-blue-400">/&gt;</span>{"\n    "}
                      <span className="text-blue-400">&lt;/div&gt;</span>{"\n  );\n"}
                    {'}'};
                    {"\n\n"}
                    <span className="text-purple-400">export default</span> <span className="text-blue-400">Achievements</span>;
                  </code>
                </pre>
              </div>
            </div>
